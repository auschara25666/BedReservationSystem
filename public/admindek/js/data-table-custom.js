  ...
  setTimeout(function () {
    ...
    $("#dt-orthogonal").DataTable({
      ...
      columns: [
        ...
        { data: "office" },
        { data: "extn" },
        { data: { _: "start_date.display", sort: "start_date.timestamp" } },
        { data: "salary" },
      ],
    });
    ...
    // $(document).ready( function () {
      ...
      //   var datef = split[0];
      //   var datet = split[1];
      //   var url = "{{ route('ward-statistic.index') }}";
      //   console.log(url);
      //  $.ajax({
      //   url: url,
      //   method :'GET',
      //   data:{datef:datef,datet:datet},
      //   dataType:'json',
...
//  }); 
    ...
    /////////////////////////////////////////////////////////////
    var table = $('#scr-vtr-dynamic-quota').DataTable({
        order: [6, 'asc']
    });
    ...
    $(document).ready( function () {
        ...
        $('.employee-search-input-quota').on( 'keyup click change', function () {
            var v =$(this).val();
            table.columns(6).search(v).draw();
        } );
    });
  /////////////////////////////////////////////////////////////
  var table = $('#scr-vtr-dynamic-normal').DataTable({
    // columnDefs: [
  ...
  $(document).ready( function () {
      ...
      $('.employee-search-input-normal').on( 'keyup click change', function () {
          var v =$(this).val();
          table.columns(6).search(v).draw();
      } );
      $('.employee-search-select-normal').on( 'keyup click change', function () {
        var s =$(this).val();
        if(s == ""){
          table.columns(4).search(s).draw();
        }
        else{
        table.columns(4).search(s).draw();
        }
...
//////////////////////////////////
var table = $('#scr-vtr-dynamic-approve').DataTable({
      order: [6, 'asc']
});
...
$(document).ready( function () {
    ...
    $('.employee-search-input-approve').on( 'keyup click change', function () {
        var v =$(this).val();
        table.columns(6).search(v).draw();
    } );
});
//////////////////////////////////
    ...
    $("#custm-tool-ele").DataTable({ dom: '<"toolbar">frtip' });
