...
setTimeout(function () {
  $(document).ready(function () {
    ...
    $(".js-example-basic-single-editmodal").select2({
        dropdownParent: $('#editDoctor')
    });
    ...
    $("#select-5").on("click", function () {
      $("#public-methods").multiSelect("select", [
        "elem_1",
        "elem_3",
        "elem_4",
        "elem_5",
    ...
    $("#deselect-5").on("click", function () {
      $("#public-methods").multiSelect("deselect", [
        "elem_1",
        "elem_3",
        "elem_4",
        "elem_5",
    ...
    $(".searchable").multiSelect({
      selectableHeader:
        "<input type='text' class='form-control' autocomplete='off' placeholder='try \"12\"'>",
      selectionHeader:
        "<input type='text' class='form-control' autocomplete='off' placeholder='try \"4\"'>",
