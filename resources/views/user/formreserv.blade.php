                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                @endif
                                                    ...
                                                    <section>
                                                        ...
                                                        <form role="form" class="wizard-form" name="myform"
                                                            action="/reservuser" id="example-advanced-form" method="POST" >
                                                            @csrf

                                                    <h3> Ward / หัตถการ </h3>
                                                    
                                                    <fieldset>
                                                         <h3 style="display: flex;justify-content: center;align-items: center;"> Ward ที่ต้องการจอง </h3>
                                                        <div class="form-group row">
                                                            <div class="col-md-2"></div>
                                                            <div class="col-md-8">
                                                            <select class="js-example-basic-single col-sm-12 required" name="ward" id="ward" >
                                                            <option value="" style="align-items: center;display: none" disabled selected>..เลือก Ward..</option>
                                                            @if (is_null($ward))
                
                                                            @else
                                                            @foreach ($ward as $lward)
                                                            <option value="{{ $lward->id }}">{{ $lward->ward_name }}
                                                            </option>
                                                            @endforeach
                                                            @endif
                                                        ...
                                                        <h3 style="display: flex;justify-content: center;align-items: center;"> หัตถการ </h3>
                                                        <span style="display: flex;justify-content: center;align-items: center;color:blue;"> ** กรุณาเลือกวอร์ดก่อนเลือกหัตถการ ระบบจะแสดงหัตถการของวอร์ดตามที่ท่านเลือก **</span>
                                                        <div class="form-group row">
                                                            <div class="col-md-2"></div>
                                                            <div class="col-md-8">
                                                            <select class="js-example-basic-single col-sm-12 required" name="opt_id" id="opt_id" >
                                                        ...
                                                        <h4 class="sub-title" style="font-size:16px;font-weight:bold;">ข้อมูลผู้ป่วย</h4>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-xl-6">
                                                                    ...
                                                                    <label class="block" for="hn" ><i class="fa fa-qrcode"></i>&nbsp;เลขบัตรประจำตัวรพ.ศรีนครินทร์(HN) </label>
                                                                            &nbsp;<label style="color:red;">* ตัวอย่าง : HN1234 (6 ตัวเท่านั้น)</label>&nbsp;<label style="color:white;font-size:16px;" class="label label-danger">หากผู้ป่วยมีข้อมูลในระบบแล้วระบบจะแสดงรหัส HN ขึ้นมาให้เลือก และจะกรอกข้อมูลให้อัตโนมัติ</label>
                                                                    <div class="form-group section-search">
                                                                        
                                                                        <div class="input-field">
                                                                            <input type="text" name="hn" class="form-control hn required"
                                                                                placeholder="ระบุ HN" autocomplete="off" onkeyup="this.value = this.value.toUpperCase();" value="{{ old('hn') }}" maxlength="6" minlength="6">
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                            <label class="block"><i
                                                                                ...
                                                                                (Sex) </label>&nbsp;<label style="color:red;">*</label>
                                                                        </div>
                                                                        <div class="col-sm-12 pa_sex_div">
                                                                            <select
                                                                                class="js-example-basic-single required"
                                                                                name="pa_sex" id="pa_sex" style="width: 500px;">
                                                                ...
                                                                <div class="col-sm-12 col-xl-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <select
                                                                                class="js-example-basic-single required"
                                                                                name="pay" id="pay" style="width: 500px;">
                                                                                <option value="" disabled selected>
                                                                                    เลือกสิทธิ์การรักษา</option>
                                                                                @if (is_null($pay))
                                                                                @else
                                                                                @foreach ($pay as $lpay)
                                                                                <option value="{{ $lpay->id }}">
                                                                                    {{ $lpay->name }}</option>
                                                                                @endforeach
                                                                                @endif
                                                                            </select>
                                                                ...
                                                                <div class="col-sm-12 col-xl-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-12 pa_disease_div">
                                                                ...
                                                                <div class="col-sm-12 col-xl-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <select
                                                                                class="js-example-basic-single required"
                                                                                name="doctor_id" id="doctor_id" style="width: 500px;">
                                                                                <option value="" disabled selected>
                                                                                    เลือกอาจารย์แพทย์</option>
                                                                                @if (is_null($doc))
                                                                                @else
                                                                                @foreach ($doc as $ldoc)
                                                                                <option value="{{ $ldoc->id }}">
                                                                                    {{ $ldoc->prefix }}{{ $ldoc->fname }} {{ $ldoc->lname }}</option>
                                                                                @endforeach
                                                                                @endif
                                                                            </select>
                                                    ...
                                                    <fieldset>
                                                        <h3 class="sub-title" style="font-size:16px;font-weight:bold;">ข้อมูลผู้จอง/ผู้รับผิดชอบผู้ป่วย ที่สามารถติดต่อได้</h3>
                                                        ...
                                                        align-items: center;">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <input type="text" class="form-control required"
                                                                            ...
                                                                            value="{{ Auth::user()->prefix }}{{ Auth::user()->fname }} {{ Auth::user()->lname }}" readonly>
                                                            ...
                                                            <div class="col-sm-12 col-xl-10">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <input type="text" class="form-control required"
                                                                            name="booking_phone" id="booking_phone"
                                                            ...
                                                            <div class="col-sm-12 col-xl-10">
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label class="block"><i
                                                                                class="fa fa-phone"></i>&nbsp;เบอร์โทรหน่วยงาน/สังกัด ที่จองเข้ามา&nbsp;
                                                                            </label><label style="color:red;">*</label>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                    ...
                                                    <input type="hidden" name="ward_in" value="{{ Auth::user()->ward_id }}">
