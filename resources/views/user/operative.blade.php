                        ...
                        <div class="nav-list">
                            <div class="pcoded-inner-navbar main-menu">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    ...
                                    <li class="active">
                                        <a href="/operativeuser" class="waves-effect waves-dark">
                                ...
                                <div class="page-wrapper">
                                    <div class="page-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div align="center">
                                                    <p style="font-size: 24px"><b>1. เลือก Ward</b></p>
                                                    <div class="form-group">
                                                        <label> <span style="color: red"></span></label>
                                                        <select class="form-control ward" name="ward" style="width: 50%">
                                                            <option value="" style="display: none">กรุณาเลือกวอร์ด
                                                            </option>
                                                            @if (is_null($ward))
                                                ...
                                                <div class="mt-5" align="center">
                                                    ...
                                                    <p style="font-size: 24px"><b>2. เลือกหัตถการ</b></p>

                                                    <p style="font-size: 16px;color :red;padding-top: 2px">
                                                        **ก่อนทำการจอง**</p>

                                                    <select class="js-example-basic-single opt_id" name="opt_id" id="opt_id" style="width: 50%"
                                                        onchange="window.location.href='formreserv-user/'+this.value">
                                                        {{-- <option value="" display="none">..กรุณาเลือกหัตถการ..</option>
                                                        @forelse ($opt as $lopt)
