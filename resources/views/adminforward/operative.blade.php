...
<body onload="startTime()">
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">หัตถการ</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-header">
                                                        <h5>จำนวนหัตถการทั้งหมด</h5>
                                                        <h5 style="color:red;">{{ $operative->count() }}</h5>
                                                        <h5>ประเภท</h5>
                                                        <button type="button" class="btn btn-primary waves-effect"
                                                            data-toggle="modal" data-target="#addOpt"
                                                            style="float:right;margin-right:50px;">เพิ่มจำนวนหัตถการ</button>
                                                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="scr-vtr-dynamic"
                                                                ...
                                                                @else
                                                                <tbody>
                                                                    @foreach ($operative as $listopt)
                                                                    <tr>
                                                                        <td>{{ $listopt->opt_name }}</td>
                                                                        <td>

                                                                            <span  data-toggle="modal" data-target="#editOpt{{ $listopt->id }}" >
                                                                            ...
                                                                            <span  data-toggle="modal" data-target="#delOpt{{ $listopt->id }}" >
                                                                    ...
                                                                    <div class="modal fade"
                                                                        id="editOpt{{ $listopt->id }}" tabindex="-1"
                                                                        role="dialog">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <form class="form-horizontal"
                                                                                    action="{{ route('operative.update',$listopt->id) }}"
                                                                                    method="post">
                                                                                    @csrf
                                                                                    {{ method_field('patch') }}
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="form-group">
                                                                                            <label for="opt_name"
                                                                                                class="control-label"><b>หัตถการ
                                                                                                    :
                                                                                                </b></label>
                                                                                            <input class="form-control"
                                                                                                type="text"
                                                                                                name="opt_name"
                                                                                                value="{{ $listopt->opt_name }}"
                                                                                                required>
                                                                                        </div>
                                                                    ...
                                                                    <!-- ///////delete//////// -->
                                                                    <div class="modal fade"
                                                                        id="delOpt{{ $listopt->id }}" tabindex="-1"
                                                                        role="dialog">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <form class="form-horizontal"
                                                                                    action="{{ route('operative.destroy',$listopt->id) }}"
                                                                                    method="post">
                                                                                    @csrf
                                                                                    {{ method_field('delete') }}
                                                                                    <div class="modal-body">
            ...
            <!-- /////////add/////////// -->
            <div class="modal fade" id="addOpt" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form class="form-horizontal" action="{{ route('operative.store') }}" method="post">
                            @csrf
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="opt_name" class="control-label">หัตถการ
                                        :</label>
                                    <input type="text" class="form-control" name="opt_name" id="opt_name" placeholder="พิมพ์ชื่อหัตถการ" required />
                                </div>
                            </div>
                            <div class="modal-footer">
