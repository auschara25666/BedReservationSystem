                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-header">
                                                        <h5>จำนวนสมาชิก(ผู้ใช้งานของ Ward)ทั้งหมด</h5>
                                                        <h5 style="color:red;">{{ $userward->count() }}</h5>
                                                        <h5>คน</h5>
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="ward" id="ward"
                                        placeholder="กรอกสังกัด" required value="{{ Auth::user()->ward }}" readonly/>
                                </div>
                            </div>
                        </div> --}}
                        ...
                        <div class="form-group">
                            <label for="phone" class="control-label"><b>สิทธิ์การใช้งาน
                                    ...
                                    <label  style="color: black;background-color:#d1eaf5;">
                                        <ul>
                                            <li>1.Admin : ผู้ดูแลระบบวอร์ด</li>
                                            <li>2.ChiefNurse : พยาบาลหัวหน้าเวร สามารถจัดดสรรเตียงได้</li>
                                            <li>3.Nurse(Ward) : พยาบาลวอร์ดและผู้ช่วยพยาบาลวอร์ด สามารถดูสถานะเตียงได้ **แต่ไม่สามารถจัดสรรเตียงได้</li>
                                            <li>4.User : แพทย์ พยาบาลและผู้ช่วยพยาบาลทั่วไป (ผู้จอง)</li>
                                        </ul>
                                    </label>
                            <select class="form-control" name="permission">
