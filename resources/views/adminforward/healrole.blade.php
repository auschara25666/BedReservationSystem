                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">สิทธิ์การรักษา</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-header">
                                                        <h5>จำนวนสิทธิ์การรักษาทั้งหมด</h5>
                                                        <h5 style="color:red;">{{ $pay->count() }}</h5>
                                                        <h5>ประเภท</h5>
                                                        <button type="button" class="btn btn-primary waves-effect"
                                                            data-toggle="modal" data-target="#add-Modal"
                                                            style="float:right;margin-right:50px;">เพิ่มสิทธิ์การรักษา</button>
                                                    </div>
                                                            ...
                                                            <table id="scr-vtr-dynamic"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <div class="modal fade"
                                                                        id="editPay{{ $listpay->id }}" tabindex="-1"
                                                                        role="dialog">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <form class="form-horizontal"
                                                                                    action="{{ route('payment.update',$listpay->id) }}"
                                                                                    method="post">
                                                                                    @csrf
                                                                                    {{ method_field('patch') }}
                                                                                    <div class="modal-header">
                                                                                        <h4 class="modal-title">
                                                                                            แก้ไขสิทธิ์การรักษา</h4>
                                                                                        <button type="button"
                                                                                            class="close"
                                                                                            data-dismiss="modal"
                                                                                            aria-label="Close">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="form-group">
                                                                                            <label for="name"
                                                                                                class="control-label"><b>สิทธิการรักษา
                                                                                                    :
                                                                                                </b></label>
                                                                    ...
                                                                    <!-- ///////delete//////// -->
                                                                    <div class="modal fade"
                                                                        id="delPay{{ $listpay->id }}" tabindex="-1"
                                                                        role="dialog">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <form class="form-horizontal"
                                                                                    action="{{ route('payment.destroy',$listpay->id) }}"
                                                                                    method="post">
                                                                                    @csrf
                                                                                    {{ method_field('delete') }}
                                                                                    <div class="modal-body">
