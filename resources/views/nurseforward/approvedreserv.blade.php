            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        <a href="/index-nurse">
                            <img class="img-fluid" src="admindek/image/logolek.png" alt="Theme-Logo" />
                        </a>
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="scr-vtr-dynamic-approve"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @php
                                                                    $user =
                                                                    \App\User::find($lreserveapply->created_user_id);
                                                                    @endphp
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ \Carbon\Carbon::parse($lreserveapply->reserve_booking)->format('d/m/Y') }}
                                                                        </td>
                                                                        <td class="text-center">
                                                                            ...
                                                                            @if ($lreserveapply->reserve_status =='ยกเลิกจอง')
                                                                                ...
                                                                                style="font-size:15px;">{{ $lreserveapply->reserve_status }}</small>
                                                                            @endif
                                                                            @if ($lreserveapply->reserve_status =='เข้าไม่ผ่านระบบ')
                                                                    ...
                                                                    <div class="modal fade"
                                                                        id="canReserve{{ $lreserveapply->id }}"
                                                                        role="dialog">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <button
                                                                                                        type="submit"
                                                                                                        class="btn waves-effect waves-light btn-danger btn-square btn-block">ยกเลิก</button>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
